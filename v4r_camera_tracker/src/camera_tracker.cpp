...
bool
CamTracker::start (v4r_camera_tracker_msgs::start_tracker::Request & req,
...
bool
CamTracker::stop (v4r_camera_tracker_msgs::start_tracker::Request & req,
      v4r_camera_tracker_msgs::start_tracker::Response & response)
{
#ifdef USE_PCL_GRABBER
    if(interface.get())
...
bool
CamTracker::doBA (v4r_camera_tracker_msgs::do_ba::Request & req,
...
bool
CamTracker::getTrackingResults (v4r_camera_tracker_msgs::get_tracking_results::Request & req,
...
bool
CamTracker::saveTrackingResultsToFile(v4r_camera_tracker_msgs::save_tracking_results_to_file::Request &req,
...
bool
CamTracker::visCompound (v4r_camera_tracker_msgs::visualize_compound::Request & req,

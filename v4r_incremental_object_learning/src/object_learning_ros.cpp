...
bool
IOL_ROS::clear_cached_model (v4r_incremental_object_learning_msgs::clear::Request & req,
...
bool
IOL_ROS::save_model (v4r_incremental_object_learning_msgs::save_model::Request & req,
...
bool
IOL_ROS::visualizeROS(v4r_incremental_object_learning_msgs::visualize::Request & req,
...
bool
IOL_ROS::learn_object (v4r_incremental_object_learning_msgs::learn_object::Request & req,
                   v4r_incremental_object_learning_msgs::learn_object::Response & response)
{
    ...
    {
        v4r_incremental_object_learning_msgs::learn_object_inc srv_learn_inc;
...
bool IOL_ROS::learn_object_inc (v4r_incremental_object_learning_msgs::learn_object_inc::Request & req,

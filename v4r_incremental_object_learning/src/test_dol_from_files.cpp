...
public:
    bool callIOL()
    {
        ...
        ros::ServiceClient IOL_clear_client = n_->serviceClient<v4r_incremental_object_learning_msgs::clear>(service_name_clear);
        v4r_incremental_object_learning_msgs::clear srv_clear;
        ...
        ros::ServiceClient IOLclient = n_->serviceClient<v4r_incremental_object_learning_msgs::learn_object>(service_name_learn);
        v4r_incremental_object_learning_msgs::learn_object srv_learn;

        std::string service_name_save = "/incremental_object_learning/save_model";
        ros::ServiceClient IOLclient_save = n_->serviceClient<v4r_incremental_object_learning_msgs::save_model>(service_name_save);
        v4r_incremental_object_learning_msgs::save_model srv_save;

        std::string service_name_vis = "/incremental_object_learning/visualize";
        ros::ServiceClient IOLclient_vis = n_->serviceClient<v4r_incremental_object_learning_msgs::visualize>(service_name_vis);
        v4r_incremental_object_learning_msgs::visualize srv_vis;

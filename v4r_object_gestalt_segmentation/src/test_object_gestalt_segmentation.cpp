...
public:
    ...
    void callUsingCam(const sensor_msgs::PointCloud2::ConstPtr& msg)
    {
        ...
        v4r_segmentation_msgs::segment srv;
    ...
    void visualizePointcloud(const v4r_segmentation_msgs::segment& srv)
    {
    ...
    bool initialize(int argc, char ** argv)
    {
        ...
        srv_client = n_->serviceClient<v4r_segmentation_msgs::segment>(service_name_sv_rec);

...
bool
ObjTrackerMono::start (v4r_object_tracker_msgs::start_tracker::Request & req,
...
bool
ObjTrackerMono::changeTrackingModel (v4r_object_tracker_msgs::change_tracking_model::Request & req,
...
bool
ObjTrackerMono::stop (v4r_object_tracker_msgs::stop_tracker::Request & req,

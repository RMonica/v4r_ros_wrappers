...
SegmenterROS<PointT>::do_segmentation_ROS(v4r_segmentation_msgs::segment::Request & req,
...
template<typename PointT> bool
SegmenterROS<PointT>::respondSrvCall(v4r_segmentation_msgs::segment::Request &req,

...
#include "v4r_object_tracker_msgs/stop_tracker.h"
#include "v4r_object_tracker_msgs/detect_and_track.h"
...
public:
    ...
    void callUsingCam(const sensor_msgs::PointCloud2::ConstPtr& msg)
    {
        ...
        if (!sv_rec_client_.call(srv)) { ROS_ERROR("Failed to call /recognition_service/sv_recognition"); return; }
            ...
            if(detected_ids.empty())
                ...
                v4r_object_tracker_msgs::start_tracker srv_obj_track_start;
                v4r_object_tracker_msgs::change_tracking_model srv_obj_track_ch_m;
    ...
    bool
    detectAndTrack( v4r_object_tracker_msgs::detect_and_track::Request & req,
                    v4r_object_tracker_msgs::detect_and_track::Response & response)
    {
        v4r_object_tracker_msgs::stop_tracker srv_obj_track_stop;
        v4r_object_tracker_msgs::cleanup srv_obj_track_cleanup;
    ...
    bool initialize(int argc, char ** argv)
    {
        ...
        obj_track_stop_ = n_->serviceClient<v4r_object_tracker_msgs::stop_tracker>(service_name_obj_tracker + "stop_recording");
        obj_track_change_model_ = n_->serviceClient<v4r_object_tracker_msgs::change_tracking_model>(service_name_obj_tracker + "change_tracking_model");
        obj_track_cleanup_ = n_->serviceClient<v4r_object_tracker_msgs::cleanup>(service_name_obj_tracker + "cleanup");

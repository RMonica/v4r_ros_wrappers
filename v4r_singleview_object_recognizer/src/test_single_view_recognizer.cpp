...
//        {
//            ros::ServiceClient retrainClient = n_->serviceClient<v4r_recognition_msgs::retrain_recognizer>("/recognition_service/mp_recognition_retrain");
//            v4r_recognition_msgs::retrain_recognizer srv;
...
//        }
    ...
    bool callSvRecognizerUsingFiles()
    {
        ...
        for(size_t i=0; i < test_cloud.size(); i++)
        {
            ...
            v4r_recognition_msgs::recognize srv_rec;
    ...
    bool initialize(int argc, char ** argv)
    {
        ...
        sv_rec_client_ = n_->serviceClient<v4r_recognition_msgs::recognize>(service_name_sv_rec);
